...
export const metadata: Metadata = {
  title: 'Male Styles',
  description: 'Male styles catalog — coming soon on Stitch-It.',
};

export default function MaleStylesPage() {
  return (
    <div className="max-w-md mx-auto px-4 py-20 text-center">
      ...
      <h1 className="font-serif text-2xl font-semibold mb-2">Male styles coming soon</h1>
