...
export const metadata: Metadata = {
  title: 'Female Styles',
  description: 'Female styles catalog — coming soon on Stitch-It.',
};

export default function FemaleStylesPage() {
  return (
    <div className="max-w-md mx-auto px-4 py-20 text-center">
      ...
      <h1 className="font-serif text-2xl font-semibold mb-2">Female styles coming soon</h1>
